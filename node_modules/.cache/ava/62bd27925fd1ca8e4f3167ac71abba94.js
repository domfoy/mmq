...
io.on('connection', socket => {
  socket.emit('connect', { t: 1 });
  socket.on('game-client-join', data => {
    console.log(data);
  });
  // console.log('connection');
  socket.emit('game-server-song-end', {
...
//# sourceMappingURL=/home/quentin/dev/mmq/node_modules/.cache/ava/62bd27925fd1ca8e4f3167ac71abba94.js.map