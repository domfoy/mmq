...
io.on('connection', client => {
  client.on('game-client-join', data => {
    console.log(data);
  });
  console.log('connection', io.emit);
  io.emit('game-server-song-end', {
...
const scope = nock(config.mmqHomeUrl).get('/').reply(200, html);
...
test('should save new track and round', async t => {
  ...
  t.true(_rec._expr(_rec._capt(_rec._capt(scope, 'arguments/0/callee/object').isDone(), 'arguments/0'), {
    content: 't.true(scope.isDone())',
    filepath: 'test/index.js',
    line: 41,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"scope","range":[7,12]},"property":{"type":"Identifier","name":"isDone","range":[13,19]},"computed":false,"range":[7,19]},"arguments":[],"range":[7,21]}],"range":[0,22]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"scope","range":[7,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"isDone","range":[13,19]},{"type":{"label":"("},"range":[19,20]},{"type":{"label":")"},"range":[20,21]},{"type":{"label":")"},"range":[21,22]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=/home/quentin/dev/mmq/node_modules/.cache/ava/37a4b3ba49f1ca1f7a601188e4fe1439.js.map